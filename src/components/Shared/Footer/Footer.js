...
const Footer = () => {
  return (
    <>
      ...
      <footer className="px-10 py-4 border-t bg-base-200 dark:bg-gray-900 text-base-content dark:text-base-100 border-base-300">
        <div className="footer lg:max-w-screen-lg xl:max-w-screen-xl w-full mx-auto">
          <div className="items-center grid-flow-col">
            ...
            <p> Classiniya. <br /><span>2023 &copy; </span> All Right Reserved.</p>
          </div>
