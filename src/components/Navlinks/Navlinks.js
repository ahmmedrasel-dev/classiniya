...
const Navlinks = () => {
  return (
    <>
      ...
      <li className='flex items-center'><NavLink to="/graphics-design" className="lg:text-sm xl:text-lg text-secondary">Graphics &  Design</NavLink><BsFillCaretDownFill className='text-gray text-[13px]' /></li>
